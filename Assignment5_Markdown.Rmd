...
#Use predict and basically the last lab to get lower and upper bounds, and then geom ribbon or whatever you want for CI around the lines
grad_new <- data.frame(City = rep(c("San Luis Obispo",
                                  "Santa Maria-Orcutt",
                                  "Atascadero",
                                  "Arroyo Grande"), 
                                each = 60), 
