...
fac_lm1 <- lm(salary ~ sex + years_service + discipline + postgrad_years, data = faculty)
fac_lm2 <- lm(salary ~ sex + discipline + postgrad_years, data = faculty)
...
stargazer(fac1_aic, fac2_aic, type = 'html', out="AIC.htm")
